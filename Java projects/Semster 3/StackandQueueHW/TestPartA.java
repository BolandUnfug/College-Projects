...
public class TestPartA{
	...
	Stack st1 = new Stack( new UnlimitedArraySlow() );
	Stack st2 = new Stack( new UnlimitedArrayFast() );
	Queue q1 = new Queue( new UnlimitedArraySlow() );
	Queue q2 = new Queue( new UnlimitedArrayFast() );
