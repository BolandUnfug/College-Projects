/**
 *  Defines a visualization tool useful for a Susceptible-Infectious-Recovered (SIR) epidemiological model, when kernel distributions are used
 *  of viral spread, in the style of a cellular automaton (CA). <br>
 * this is a sublcass of the screen, but I copied everything over because i would not have finished in time lol.
 *  <br>
...
public class SIRProbabilityScreen implements Screen {
    ...
    // SIR components
    private SIRProbabilityMap map;                 //  the map of references to the actual cell objects themselves
     ...
     */
    public SIRProbabilityScreen(SIRProbabilityMap world ) {
