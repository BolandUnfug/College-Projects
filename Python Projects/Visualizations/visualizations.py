...
def literalHeatMap( data, title=""):
	...
	def animate(i): # run every frame
		...
		framedata[int(data[i,0])-1][int(data[i,1])-1] = data[i][2] # changes value of framedata to tempurature
		im = ax.imshow( framedata, interpolation='nearest', aspect='auto' ) # updates the graph
